...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { account_id: @posting.account_id, amount: @posting.amount, journal_id: @posting.journal_id }
    end
  ...
  test "should update posting" do
    patch :update, id: @posting, posting: { account_id: @posting.account_id, amount: @posting.amount, journal_id: @posting.journal_id }
    assert_redirected_to posting_path(assigns(:posting))
  end
